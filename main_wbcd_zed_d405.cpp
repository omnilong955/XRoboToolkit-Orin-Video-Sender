...
// WBCD layout: one H.264 stream, top row ZED stereo, bottom row D405 hands.
#ifndef WBCD_OUTPUT_WIDTH
#define WBCD_OUTPUT_WIDTH 2560
#endif
#ifndef WBCD_OUTPUT_HEIGHT
#define WBCD_OUTPUT_HEIGHT 1440
#endif
#ifndef WBCD_OUTPUT_FPS
#define WBCD_OUTPUT_FPS 30
#endif
#ifndef WBCD_DEFAULT_BITRATE
#define WBCD_DEFAULT_BITRATE 4000000
#endif
#ifndef WBCD_EYE_WIDTH
#define WBCD_EYE_WIDTH 1280
#endif
#ifndef WBCD_EYE_HEIGHT
#define WBCD_EYE_HEIGHT 720
#endif
#ifndef WBCD_D405_WIDTH
#define WBCD_D405_WIDTH 640
#endif
#ifndef WBCD_D405_HEIGHT
#define WBCD_D405_HEIGHT 480
#endif
#ifndef WBCD_D405_FPS
#define WBCD_D405_FPS 30
#endif

constexpr int kOutputWidth = WBCD_OUTPUT_WIDTH;
constexpr int kOutputHeight = WBCD_OUTPUT_HEIGHT;
constexpr int kOutputFps = WBCD_OUTPUT_FPS;
constexpr int kDefaultBitrate = WBCD_DEFAULT_BITRATE;
constexpr int kEyeWidth = WBCD_EYE_WIDTH;
constexpr int kEyeHeight = WBCD_EYE_HEIGHT;
constexpr int kD405Width = WBCD_D405_WIDTH;
constexpr int kD405Height = WBCD_D405_HEIGHT;
constexpr int kD405Fps = WBCD_D405_FPS;
...
std::string buildPipelineString(int bitrate, bool use_hevc, bool preview) {
  ...
  std::string pipeline =
      ...
      std::to_string(std::max(bitrate, kDefaultBitrate)) + " ! " + parser +
